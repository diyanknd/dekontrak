...
var hljs = (function () {
  ...
  const J = t,
    ...
    ne = (t) => {
      ...
      function f(e, t, i, r) {
        ...
        function b(e, n) {
          return (
            ...
            e.beginScope && (e.beginScope._wrap ? (g(S, N.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap), (S = '')) : e.beginScope._multi && (u(e.beginScope, n), (S = ''))),
            (O = Object.create(e, {
              parent: {
                value: O
              }
        ...
        function h(e) {
          ...
          if (!i) return ee
          const r = O
          O.endScope && O.endScope._wrap ? (d(), g(n, O.endScope._wrap)) : O.endScope && O.endScope._multi ? (d(), u(O.endScope, e)) : r.skip ? (S += n) : (r.returnEnd || r.excludeEnd || (S += n), d(), r.excludeEnd && (S = n))
          do {
        ...
        function w(a, r) {
          ...
          if (((y = r), 'begin' === r.type))
            return ((e) => {
              ...
              return a.skip ? (S += t) : (a.excludeBegin && (S += t), d(), a.returnBegin || a.excludeBegin || (S = t)), b(a, e), a.returnBegin ? 0 : t.length
            })(r)
          if ('illegal' === r.type && !i) {
        ...
        try {
          ...
          return A.finalize(), (x = A.toHTML()), { language: e, value: x, relevance: C, illegal: !1, _emitter: A, _top: O }
        } catch (n) {
          if (n.message && n.message.includes('Illegal')) return { language: e, value: J(t), illegal: !0, relevance: 0, _illegalBy: { message: n.message, index: T, context: t.slice(T - 100, T + 100), mode: n.mode, resultSoFar: x }, _emitter: A }
          if (s)
            return {
              language: e,
              value: J(t),
      ...
      function y(e) {
        ...
        if (_(t)) return
        if ((O('before:highlightElement', { el: e, language: t }), e.dataset.highlighted)) return void console.log('Element previously highlighted. To highlight again, first unset `dataset.highlighted`.', e)
        if (
          e.children.length > 0 &&
          (p.ignoreUnescapedHTML || (console.warn('One of your code blocks includes unescaped HTML. This is a potentially serious security risk.'), console.warn('https://github.com/highlightjs/highlight.js/wiki/security'), console.warn('The element with unescaped HTML:'), console.warn(e)),
  ...
  function ve(e) {
    ...
    const _ = [].concat(m, c.contains),
      ...
      f = { className: 'params', begin: /(\s*)\(/, end: /\)/, excludeBegin: !0, excludeEnd: !0, keywords: i, contains: h },
      E = {
        variants: [
          {
      ...
      y = { relevance: 0, match: n.either(/\bJSON/, /\b[A-Z][a-z]+([A-Z][a-z]*|\d)*/, /\b[A-Z]{2,}([A-Z][a-z]+|\d)+([A-Z][a-z]*)*/, /\b[A-Z]{2,}[a-z]+([A-Z][a-z]+|\d)*([A-Z][a-z]*)*/), className: 'title.class', keywords: { _: [...fe, ...Ee] } },
      w = {
        variants: [
          {
      ...
      N = {
        match: n.concat(/\b/, ((v = [...ye, 'super', 'import'].map((e) => e + '\\s*\\(')), n.concat('(?!', v.join('|'), ')')), t, n.lookahead(/\s*\(/)),
  ...
  var Pe = Object.freeze({
    ...
    grmr_bash: (e) => {
      ...
      i.contains.push(o)
      const l = { begin: /\$?\(\(/, end: /\)\)/, contains: [{ begin: /\d+#[0-9a-f]+/, className: 'number' }, e.NUMBER_MODE, t] },
        c = e.SHEBANG({ binary: '(fish|bash|zsh|sh|csh|ksh|tcsh|dash|scsh)', relevance: 10 }),
        d = { className: 'function', begin: /\w[\w\d_]*\s*\(\s*\)\s*\{/, returnBegin: !0, contains: [e.inherit(e.TITLE_MODE, { begin: /\w[\w\d_]*/ })], relevance: 0 }
      return {
        name: 'Bash',
        aliases: ['sh', 'zsh'],
        keywords: {
    ...
    grmr_csharp: (e) => {
      ...
      const g = { variants: [{ className: 'string', begin: /"""("*)(?!")(.|\n)*?"""\1/, relevance: 1 }, c, l, i, e.APOS_STRING_MODE, e.QUOTE_STRING_MODE] },
      ...
      return {
        ...
        contains: [
          ...
          },
          {
            ...
            keywords: i,
            contains: [{ className: 'params', begin: /\(/, end: /\)/, keywords: i, relevance: 0, contains: [r, e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, be, e.C_BLOCK_COMMENT_MODE] }, e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE]
          },
          be,
          r
        ]
    ...
    grmr_json: (e) => {
      ...
      return {
        ...
        contains: [{ className: 'attr', begin: /"(\\.|[^\\"\r\n])*"(?=\s*:)/, relevance: 1.01 }, { match: /[{}[\],:]/, className: 'punctuation', relevance: 0 }, e.QUOTE_STRING_MODE, t, e.C_NUMBER_MODE, e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE],
        illegal: '\\S'
      }
    },
    grmr_kotlin: (e) => {
    ...
    grmr_less: (e) => {
      ...
      const g = s.concat({
        ...
        b = { begin: i + '\\s*:', returnBegin: !0, end: /[;}]/, relevance: 0, contains: [{ begin: /-(webkit|moz|ms|o)-/ }, n.CSS_VARIABLE, { className: 'attribute', begin: '\\b(' + le.join('|') + ')\\b', end: /(?=:)/, starts: { endsWithParent: !0, illegal: '[<=$]', relevance: 0, contains: s } }] },
    ...
    grmr_perl: (e) => {
      const n = e.regex,
        ...
        b = [
          ...
          { className: 'function', beginKeywords: 'sub method', end: '(\\s*\\(.*?\\))?[;{]', excludeEnd: !0, relevance: 5, contains: [e.TITLE_MODE, s] },
    ...
    grmr_swift: (e) => {
      const n = { match: /\s+/, relevance: 0 },
        ...
        R = {
          ...
          relevance: 0,
          contains: [
            { className: 'type', match: b(/(AV|CA|CF|CG|CI|CL|CM|CN|CT|MK|MP|MTK|MTL|NS|SCN|SK|UI|WK|XC)/, $e, '+') },
      ...
      const I = {
        ...
        U = {
          ...
          keywords: l,
          contains: [L, ...c, { begin: /:/, end: /\{/, keywords: l, contains: [{ scope: 'title.class.inherited', match: ze }, ...c], relevance: 0 }]
        }
      ...
      return { name: 'Swift', keywords: l, contains: [...a, $, F, U, z, j, { beginKeywords: 'import', end: /$/, contains: [...a], relevance: 0 }, A, ...c, ...g, ...p, f, k, ...C, ...T, R, I] }
    },
    grmr_typescript: (e) => {
      const n = ve(e),
        t = pe,
        ...
        s = { $pattern: pe, keyword: _e.concat(['type', 'interface', 'public', 'private', 'protected', 'implements', 'declare', 'abstract', 'readonly', 'enum', 'override', 'satisfies']), literal: he, built_in: Ne.concat(a), 'variable.language': we },
