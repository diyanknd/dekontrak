          ...
          ;(function (t) {
            ;(function () {
                  ...
                  '#text' === t.nodeName
                    ...
                    : '#comment' === t.nodeName
                      ...
                      : (e
                        ...
                        s.valueDiffing &&
                          (t.value && g(i, 'HTMLButtonElement', 'HTMLDataElement', 'HTMLInputElement', 'HTMLLIElement', 'HTMLMeterElement', 'HTMLOptionElement', 'HTMLProgressElement', 'HTMLParamElement') && (i.value = t.value),
                    ...
                    : (t.attributes &&
                      ...
                      e.valueDiffing &&
                        ...
                        g(t, 'HTMLInputElement') && ['radio', 'checkbox'].includes(t.type.toLowerCase()) && void 0 !== t.checked
                          ? (s.checked = t.checked)
                          : g(t, 'HTMLButtonElement', 'HTMLDataElement', 'HTMLInputElement', 'HTMLLIElement', 'HTMLMeterElement', 'HTMLOptionElement', 'HTMLProgressElement', 'HTMLParamElement') && (s.value = t.value),
                ...
                I = function (t, e) {
                  ...
                  return (
                    t.replace(A, function (r, l) {
                      ...
                      if (
                        (!d || s.voidElement) &&
                        (n > -1 && (s.voidElement || (e.caseSensitive && s.node.nodeName === r.slice(2, -1)) || (!e.caseSensitive && s.node.nodeName.toUpperCase() === r.slice(2, -1).toUpperCase())) && --n > -1 && ('svg' === s.node.nodeName && (o = !1), (s = a[n])), '<' !== u && u)
                      ) {
                  ...
                  return (
                    ...
                    (t.prototype.findDiffs = function (t, e) {
                      ...
                      do {
                        ...
                        0 === (s = this.findNextDiff(t, e, [])).length && (O(t, e) || (this.foundAll ? console.error('Could not find remaining diffs!') : ((this.foundAll = !0), N(t), (s = this.findNextDiff(t, e, []))))),
                    ...
                    (t.prototype.findOuterDiff = function (t, e, s) {
                      ...
                      if (t.nodeName !== e.nodeName) {
                        ...
                        return [new m().setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, x(t)).setValue(this.options._const.newValue, x(e)).setValue(this.options._const.route, s)]
                      }
                      ...
                      if (Object.prototype.hasOwnProperty.call(t, 'data') && t.data !== e.data)
                        return '#text' === t.nodeName
                          ? [new m().setValue(this.options._const.action, this.options._const.modifyTextElement).setValue(this.options._const.route, s).setValue(this.options._const.oldValue, t.data).setValue(this.options._const.newValue, e.data)]
                          : [new m().setValue(this.options._const.action, this.options._const.modifyComment).setValue(this.options._const.route, s).setValue(this.options._const.oldValue, t.data).setValue(this.options._const.newValue, e.data)]
                      for (n = t.attributes ? Object.keys(t.attributes).sort() : [], a = e.attributes ? Object.keys(e.attributes).sort() : [], o = n.length, l = 0; l < o; l++)
                        (i = n[l]),
                          -1 === (r = a.indexOf(i))
                            ? d.push(new m().setValue(this.options._const.action, this.options._const.removeAttribute).setValue(this.options._const.route, s).setValue(this.options._const.name, i).setValue(this.options._const.value, t.attributes[i]))
                            : (a.splice(r, 1),
                      ...
                      for (o = a.length, l = 0; l < o; l++) (i = a[l]), d.push(new m().setValue(this.options._const.action, this.options._const.addAttribute).setValue(this.options._const.route, s).setValue(this.options._const.name, i).setValue(this.options._const.value, e.attributes[i]))
                      return d
                    }),
                    (t.prototype.findInnerDiff = function (t, e, s) {
                      ...
                      for (var h = 0; h < a; h += 1) {
                        ...
                        o &&
                          (u && !p
                            ? '#text' === u.nodeName
                              ? (r.push(new m().setValue(this.options._const.action, this.options._const.removeTextElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.value, u.data)), (l -= 1))
                              : (r.push(new m().setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.element, x(u))), (l -= 1))
                            : p &&
                              !u &&
                              ('#text' === p.nodeName
                                ? r.push(new m().setValue(this.options._const.action, this.options._const.addTextElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.value, p.data))
                                : r.push(new m().setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.element, x(p))))),
                          u &&
                            p &&
                            (!this.options.maxChildCount || a < this.options.maxChildCount
                              ...
                              : O(u, p) ||
                                (i.length > n.length
                                  ? ('#text' === u.nodeName
                                      ? r.push(new m().setValue(this.options._const.action, this.options._const.removeTextElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.value, u.data))
                                      : r.push(new m().setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.element, x(u)).setValue(this.options._const.route, s.concat(l))),
                                    i.splice(h, 1),
                                    (h -= 1),
                                    (l -= 1),
                                    (o -= 1))
                                  : i.length < n.length
                                    ? ((r = r.concat([new m().setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.element, x(p)).setValue(this.options._const.route, s.concat(l))])), i.splice(h, 0, x(p)), (o -= 1))
                                    : (r = r.concat([new m().setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, x(u)).setValue(this.options._const.newValue, x(p)).setValue(this.options._const.route, s.concat(l))])))),
                          (l += 1)
                      }
                      ...
                      for (
                        ...
                        if (!n || (!0 !== h[v] && !0 !== u[v]))
                          if (!0 === h[w])
                            if ('#text' === (l = p[w]).nodeName)
                              if ('#text' === f[v].nodeName) {
                                if (l.data !== f[v].data) {
                                  ...
                                  d || b.push(new m().setValue(this.options._const.action, this.options._const.modifyTextElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.oldValue, l.data).setValue(this.options._const.newValue, f[v].data))
                                }
                              } else
                                b.push(new m().setValue(this.options._const.action, this.options._const.removeTextElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.value, l.data)),
                                  h.splice(w, 1),
                                  p.splice(w, 1),
                                  (g = Math.min(h.length, u.length)),
                                  (w -= 1),
                              ...
                              !0 === u[v]
                                ? b.push(new m().setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, x(l)).setValue(this.options._const.newValue, x(f[v])).setValue(this.options._const.route, i.concat(w)))
                                : (b.push(new m().setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.element, x(l))),
                                  h.splice(w, 1),
                                  p.splice(w, 1),
                                  (g = Math.min(h.length, u.length)),
                                  (w -= 1),
                            ...
                            '#text' === (l = f[v]).nodeName
                              ? (b.push(new m().setValue(this.options._const.action, this.options._const.addTextElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.value, l.data)),
                                h.splice(w, 0, !0),
                                p.splice(w, 0, { nodeName: '#text', data: l.data }),
                                (g = Math.min(h.length, u.length)))
                              : (b.push(new m().setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.element, x(l))), h.splice(w, 0, !0), p.splice(w, 0, x(l)), (g = Math.min(h.length, u.length)))
                          else if (h[w] !== u[v]) {
                            ...
                            if (((r = s[h[w]]), (o = Math.min(r.newValue, p.length - r.length)) !== r.oldValue)) {
                              ...
                              if (a) return [new m().setValue(this.options._const.action, this.options._const.relocateGroup).setValue(this.options._const.groupLength, r.length).setValue(this.options._const.from, r.oldValue).setValue(this.options._const.to, o).setValue(this.options._const.route, i)]
                            }
                          }
                      return b
                    }),
                    (t.prototype.findValueDiff = function (t, e, s) {
                      var i = []
                      return (
                        t.selected !== e.selected && i.push(new m().setValue(this.options._const.action, this.options._const.modifySelected).setValue(this.options._const.oldValue, t.selected).setValue(this.options._const.newValue, e.selected).setValue(this.options._const.route, s)),
                        (t.value || e.value) &&
                          t.value !== e.value &&
                          'OPTION' !== t.nodeName &&
                          i.push(
                        ...
                        t.checked !== e.checked && i.push(new m().setValue(this.options._const.action, this.options._const.modifyChecked).setValue(this.options._const.oldValue, t.checked).setValue(this.options._const.newValue, e.checked).setValue(this.options._const.route, s)),
                        i
                      )
                    }),
                    t
              ...
              const F = (t, e, s, { classes: i, format: n, hiddenHeader: a, sortable: o, scrollY: r, type: l }, { noColumnWidths: d, unhideHeader: c }) => ({
                  ...
                  childNodes: t
                    .map((t, h) => {
                      ...
                      return { nodeName: 'TH', attributes: f, childNodes: (!a && !r.length) || c ? (p.sortable && o ? [{ nodeName: 'BUTTON', attributes: { class: p.filter ? i.filter : i.sorter }, childNodes: m }] : m) : [{ nodeName: '#text', data: '' }] }
                    })
                    .filter((t) => t)
                }),
                B = (t, e, s, i, n, a, { classes: r, hiddenHeader: l, header: d, footer: c, format: h, sortable: p, scrollY: f, type: m, rowRender: g, tabIndex: b }, { noColumnWidths: v, unhideHeader: w, renderHeader: _ }, y, D) => {
                  const M = {
                    nodeName: 'TABLE',
                    attributes: { ...t },
                    childNodes: [
                  ...
                  if (t.headings) o.headings = t.headings.map((t) => X(t))
                    ...
                    o.headings = Array.from(e.tHead.querySelectorAll('th')).map((t, e) => {
                      const o = ((t) => {
                        ...
                        let s
                        return (s = !e.childNodes || (1 === e.childNodes.length && '#text' === e.childNodes[0].nodeName) ? { data: t.innerText, type: 'string' } : { data: e.childNodes, type: 'html', text: a(e) }), (s.attributes = e.attributes), s
                      })(t)
              ...
              const tt = {
                  ...
                  labels: { placeholder: 'Search...', searchTitle: 'Search within table', perPage: 'entries per page', pageTitle: 'Page {page}', noRows: 'No entries found', noResults: 'No results match your search query', info: 'Showing {start} to {end} of {rows} entries' },
                  template: (t, e) =>
                ...
                editRowModal() {
                  ...
                  t.forEach((t, e) => {
                    ...
                    if ((!s.hidden || (s.hidden && this.options.hiddenColumns)) && !this.options.excludeColumns.includes(e)) {
                      ...
                      a.insertBefore(
                        n('div', { class: this.options.classes.row, html: [`<div class='${this.options.classes.row}'>`, `<label class='${this.options.classes.label}'>${r(s)}</label>`, `<input class='${this.options.classes.input}' value='${r(o(t))}' type='text'>`, '</div>'].join('') }),
                        a.lastElementChild
                      )
                    }
                  }),
                    ...
                    ? (this.editingCell
                        ...
                        : e.childNodes.forEach((s, i) => {
                            const n = l(i, this.dt.columns.settings),
                              a = t[n]
                            this.options.excludeColumns.includes(n) || (e.childNodes[i].childNodes = [{ nodeName: 'INPUT', attributes: { type: 'text', value: r(a.text || String(a.data) || ''), class: this.options.classes.input } }])
                          }),
                      e)
                    : e
                }
              }
              const nt = { classes: { button: 'datatable-column-filter-button', menu: 'datatable-column-filter-menu', container: 'datatable-column-filter-container', wrapper: 'datatable-column-filter-wrapper' }, labels: { button: 'Filter columns within the table' }, hiddenColumns: [] }
              class at {
                addedButtonDOM
                menuOpen
                buttonDOM
              ...
              ;(s.DataTable = class {
                ...
                _renderTable(t = {}) {
                  let e
                  e = (this.options.paging || this._searchQueries.length || this.columns._state.filters.length) && this._currentPage && this.pages.length && !t.noPaging ? this.pages[this._currentPage - 1] : this.data.data.map((t, e) => ({ row: t, index: e }))
                ...
                _renderSeparateHeader() {
                  ...
                  let e = { nodeName: 'TABLE', attributes: this._tableAttributes, childNodes: [{ nodeName: 'THEAD', childNodes: [F(this.data.headings, this.columns.settings, this.columns._state, this.options, { unhideHeader: !0 })] }] }
                ...
                insert(t) {
                  ...
                  if (Array.isArray(t)) {
                    ...
                    t.forEach((t, i) => {
                      ...
                      Object.entries(t).forEach(([t, s]) => {
                        const a = e.indexOf(t)
                        a > -1 ? (n[a] = Q(s, this.columns.settings[a])) : this.hasHeadings || this.hasRows || 0 !== i || ((n[e.length] = Q(s, this.columns.settings[e.length])), e.push(t), this.data.headings.push(X(t)))
                      }),
                        s.push({ cells: n })
                    })
                  } else
