...
;(function () {
  ...
  document.addEventListener('alpine:init', () => {
    ...
    Alpine.store('app', {
      ...
      currentColor: localStorage.getItem('primaryColor') || '44 123 229',
    ...
    Alpine.data('copyorviewcode', () => ({
      ...
      copyCode(el) {
        ...
        const codeText = el.parentElement.querySelector('pre code').innerText.trim()
        // Copy the text to clipboard
        navigator.clipboard
          .writeText(codeText)
          .then(() => {
            this.showMessage('Code Copied Successfully')
          })
          .catch((err) => {
            this.showMessage('Failed to Copy Code: ' + err, 'error')
          })
      },
    ...
    Alpine.data('pagination', () => ({
      ...
      get pageNumbers() {
        ...
        while (i <= this.totalPages) {
          if (i <= (this.currentPage > 3 ? 1 : 4) || i >= this.totalPages || (i >= this.currentPage - 1 && i <= this.currentPage + 1)) {
            pagination.push(i)
            i++
          } else {
            pagination.push('...')
    ...
    Alpine.data('countdown', () => ({
      ...
      start() {
        // Set the total number of seconds for the countdown
        this.totalSeconds = 252288000 // 1 hour
      ...
      calculateTimeUnits() {
        const months = Math.floor(this.totalSeconds / (3600 * 24 * 30))
        const days = Math.floor((this.totalSeconds % (3600 * 24 * 30)) / (3600 * 24))
  ...
  if (dropzoneEl) {
    const myDropzone = new Dropzone('#multi-file', {
      ...
      <div class="size-12 text-2xl f-center  rounded-md text-neutral-0 bg-primary-300">
      <i data-dz-thumbnail />
      </div>
              <div>
      ...
      <button class="hover:bg-neutral-30 size-7 mr-3 rounded-full duration-300 f-center" data-dz-remove>
    ...
    const singleDropzone = new Dropzone('#single-file', {
      ...
      previewTemplate: `
            ...
            <div class="dz-size not-italic" data-dz-size></div>
              ...
              <button class="text-xl size-7 absolute top-5 right-5 rounded-full f-center bg-neutral-40 dark:bg-neutral-100" data-dz-remove>
  ...
  if (document.getElementById('avatar-upload')) {
    const avatarDropzone = new Dropzone('#avatar-upload', {
      ...
      previewTemplate: `
            ...
            <div
            class="size-40 rounded-full f-center cursor-pointer  clickable-avatar  bg-neutral-20 dark:bg-neutral-903 border-4 border-neutral-0 dark:border-neutral-904">
  ...
  if (productImgUploadEl) {
    const myDropzone = new Dropzone('#product-img-upload', {
      ...
      previewTemplate: `<div class="size-20 relative items-center rounded-lg border border-neutral-30 dark:border-r-neutral-500 mt-4">
          ...
          <button class="bg-error-50 border border-error-300 absolute top-1 right-1 size-4 rounded-full duration-300 f-center" data-dz-remove>
  ...
  // nft slider
  if (document.querySelector('.nft-slider')) {
    const blogSlider = new Swiper('.nft-slider', {
      slidesPerView: 'auto',
      loop: true,
      autoplay: {
        delay: 3500
  ...
  // special-music-slider
  if (document.querySelector('.special-music-slider')) {
    const blogSlider = new Swiper('.special-music-slider', {
      slidesPerView: 'auto',
      loop: true,
      autoplay: {
        delay: 3500
  ...
  // music-hero-slider
  if (document.querySelector('.music-hero-slider')) {
    const productSwiper = new Swiper('.music-hero-slider', {
      slidesPerView: 1,
      loop: true,
      autoplay: true,
      pagination: {
        el: '.music-hero-pagination',
        clickable: true
      }
    })
  }
  ...
  if (document.querySelector('#tom-single')) {
    new TomSelect('#tom-single', {
      ...
      render: {
        option: function (data, escape) {
          return '<div class="flex"><span>' + escape(data.text) + '</div>'
        },
        item: function (data, escape) {
  ...
  if (menu_items.length > 0) {
    ...
    menu_items.forEach((link) => {
      ...
      if (filename == cleanHref) {
        ...
        const elementRect = link.getBoundingClientRect()
  ...
  const submenuHorizontal = document.querySelectorAll('.menu-link-horiz')
...
document.addEventListener('DOMContentLoaded', function () {
  if (document.getElementById('basic-table')) {
    const datatable = new simpleDatatables.DataTable('#basic-table', { perPage: 7 })
  ...
  if (document.getElementById('advance-datatable')) {
    const datatable = new simpleDatatables.DataTable('#advance-datatable', { perPage: 6 })

    document.getElementById('export-csv2').addEventListener('click', () => {
      simpleDatatables.exportCSV(datatable)
    })
    document.getElementById('export-json2').addEventListener('click', () => {
      simpleDatatables.exportJSON(datatable)
    })
