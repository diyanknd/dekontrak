...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo base_url(); ?>/assets/Softify/Softify/dist/asstes/images/favicon.ico" type="image/x-icon" />
  <link rel="preconnect" href="https://fonts.googleapis.com" />
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
  <link rel="stylesheet" href="<?php echo base_url(); ?>/assets/Softify/Softify/dist/assets/fonts/line-awesome/css/line-awesome.min.css" />
  ...
  <div class="text-neutral-700 dark:text-neutral-10">
    ...
    <div class="flex justify-between items-center gap-4 bb-dashed-n30">
      ...
      <button class="border flex items-center h-[86px] justify-center grow p-6 rounded-lg" @click="$store.app.toggleContrast('high')" :class="$store.app.contrast=='high'?'border-primary-300 bg-primary-50 text-primary-300':'border-neutral-30 dark:border-neutral-500'">
        <img src="<?php echo base_url(); ?>/assets/Softify/Softify/dist/assets/images/contrast.png" width="24" class="dark:brightness-0 dark:invert" alt="" />
      </button>
    </div>
...
<section class="text-neutral-700 dark:text-neutral-20 bg-neutral-0 dark:bg-neutral-904">
    ...
    <div class="relative" x-data="{open:false}">
      ...
      <ul class="flex w-[300px] flex-col p-4">
        <div class="flex cursor-pointer gap-2 rounded-md p-2 duration-300 hover:bg-primary-300/10">
          <img src="<?php echo base_url(); ?>/assets/Softify/Softify/dist/assets/images/users/user-s-3.png" width="44" height="40" class="shrink-0 rounded-full" alt="img" />
          <div class="text-sm">
        ...
        <div class="flex cursor-pointer gap-2 rounded-md p-2 duration-300 hover:bg-primary-300/10">
          <img src="<?php echo base_url(); ?>/assets/Softify/Softify/dist/assets/images/users/user-s-4.png" width="44" height="40" class="shrink-0 rounded-full" alt="img" />
          <div class="text-sm">
            <div class="flex gap-1">
        ...
        <div class="flex cursor-pointer gap-2 rounded-md p-2 duration-300 hover:bg-primary-300/10">
          <img src="<?php echo base_url(); ?>/assets/Softify/Softify/dist/assets/images/users/user-s-2.png" width="44" height="40" class="shrink-0 rounded-full" alt="img" />
          <div class="text-sm">
            <div class="flex gap-1">
        ...
        <div class="flex cursor-pointer gap-2 rounded-md p-2 duration-300 hover:bg-primary-300/10">
          <img src="<?php echo base_url(); ?>/assets/Softify/Softify/dist/assets/images/users/user-s-1.png" width="44" height="40" class="shrink-0 rounded-full" alt="img" />
          <div class="text-sm">
            <div class="flex gap-1">
  ...
  <div x-data="dropdown" class="relative shrink-0">
    <div title="User Profile" @click="toggle" class="size-9 cursor-pointer">
      <img src="<?php echo base_url(); ?>/assets/Softify/Softify/dist/assets/images/users/user-s-4.png" class="rounded-full" alt="profile img" />
    </div>
    <div @click.away="close" x-show="isOpen" class="absolute top-full z-20 rounded-md bg-neutral-0 shadow-[0px_6px_30px_0px_rgba(0,0,0,0.08)] duration-300 dark:bg-neutral-904 ltr:right-0 ltr:origin-top-right rtl:left-0 rtl:origin-top-left">
      <div class="flex flex-col items-center border-b border-neutral-30 p-3 text-center dark:border-neutral-500 lg:p-4">
        <img src="<?php echo base_url(); ?>/assets/Softify/Softify/dist/assets/images/users/user-s-4.png" width="60" height="60" class="rounded-full" alt="profile img" />
      ...
      <ul class="flex w-[250px] flex-col p-4">
        ...
        <li>
          <a href="<?php echo site_url('page/logout'); ?>" class="flex items-center gap-2 rounded-md px-2 py-1.5 duration-300 hover:bg-primary-300/10 hover:text-primary-300">
            <span>
...
<ul class="flex flex-col gap-2 bb-dashed-n30 xl:mb-5 xl:pb-5 text-sm font-medium">
  ...
  <li class="relative">
    <button :class="opened=='list' ? 'bg-primary-50 text-primary-300' : ''" @click="openMenu('list')" class="submenu-btn-v">
      <span class="flex items-center gap-2">
        <i class="las la-user-alt text-xl text-primary-300"></i>
        <span>E Kontrak</span>
      </span>
      <i :class="opened=='list' ? 'las la-minus rotate-180 text-primary-300' : 'las la-plus'" class="text-lg duration-300"></i>
    </button>
...
<li class="relative xl:flex xl:justify-center group-hover:block group-hover:justify-start">
  <button :class="opened=='list' ? 'bg-primary-50 text-primary-300' : ''" @click="openMenu('list')" class="submenu-btn-h">
    <span class="flex items-center gap-2">
      <i class="las la-user-alt text-xl text-primary-300"></i>
      <span class="xl:hidden group-hover:block">E Kontrak</span>
    </span>
    <i :class="opened=='list' ? 'las la-minus rotate-180 text-primary-300' : 'las la-plus'" class="text-xl duration-300 xl:hidden group-hover:block"></i>
  </button>
  <div x-show="opened=='list'" x-collapse>
    <ul class="mt-3 ltr:ml-6 rtl:mr-6 flex-col ltr:border-l rtl:border-r xl:hidden group-hover:flex border-primary-300" data-submenu="list">
      <li>
...
<nav :class="$store.app.menu=='horizontal'?'hidden xl:block':'hidden'" class="fixed z-[9] px-4 top-0 left-0 right-0 w-full mx-auto bg-neutral-0 dark:bg-neutral-904 mt-[60px] md:mt-[66px]">
  <div class="max-w-[1704px] mx-auto">
    <ul class="flex gap-5 items-center">
        ...
        <li class="relative group">
          <button class="inline-flex py-3 text-sm font-medium items-center gap-2">Ekontrak <i class="las la-plus group-hover:hidden text-lg"></i><i class="las la-minus hidden text-lg group-hover:inline-block"></i></button>
          <ul class="submenu-horiz">
