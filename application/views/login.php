                ...
                <div class="col-span-12 lg:col-span-6 xxl:col-span-5">
                    ...
                    <form class="">
                        ...
                        <div x-data="{showPass: false}" class="form-input rounded-3xl">
                            <input :type="showPass?'text':'password'" id="pass2" class="!rounded-full"
                        ...
                        <p class="mb-7 xl:mb-10">Don't have an account? <a href="sign-up.html"
                                class="font-semibold text-primary-300">Signup</a></p>
