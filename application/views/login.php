    ...
    <div class="container overflow-y-auto">
      <div
        ...
        <div class="col-span-12 lg:col-span-6 xxl:col-span-5">
          <h3 class="mb-4 xl:mb-6">DEKONTRAK</h3>
          <p class="mb-7 xl:mb-10">Masuk <b>DEKONTRAK</b> menggunakan akun <b>SIJANTAN</b></p>
          ...
          <div x-data="{showPass: false}" class="form-input rounded-3xl mb-5">
            <input :type="showPass?'text':'password'" name="password" id="pass2" placeholder="Textfield" />
          ...
          <div x-data="{ singleOne: '<?php echo $currentYear; ?>' }" class="n20 rounded-3xl mb-5">
            <select x-model="singleOne" id="tom-single-one" name="tahun" data-placeholder="Select item">
              <?php
          ...
          <?php if ($this->session->flashdata('success')): ?>
            <div id="success-alert"
              class="py-3 px-4 md:px-6 lg:px-8 rounded-xl bg-info-300/10 flex justify-between items-center">
          ...
          <?php if ($this->session->flashdata('error')): ?>
            <div id="error-alert"
              class="py-3 px-4 md:px-6 lg:px-8 rounded-xl bg-red-300/10 flex justify-between items-center">
              <div class="flex gap-5 items-center">
              ...
              <span class="cursor-pointer size-9 rounded-full hover:bg-red-300/30 duration-300 f-center"
