    ...
    <div class="container" style="padding-top: 25px;">
        ...
        <table>
            <td style="text-align:justify">
                Berdasarkan Surat Perjanjian (Kontrak) Nomor : <?php echo $row1->nomor_surat_perjanjian; ?> tanggal
                <?php echo formatTanggalIndonesia($row1->tanggal_surat_perjanjian); ?>, bersama ini memerintahkan:
            </td>
        </table>
        <!-- END: Isi 2 -->
        ...
        <table>
            ...
            <tr>
                ...
                <td>:</td>
                <td><?php echo $penyedia_jasa->nama_direktur; ?> (<?= $penyedia_jasa->jabatan ?>)</td>
            </tr>
            <tr>
        ...
        <table style="text-align:justify;margin-bottom:1px">
            ...
            <tr>
                ...
                <td style="width:2%; vertical-align: top;">:</td>
                <td style="vertical-align: top;"><?php echo formatTanggalIndonesia($row1->tanggal_mulai); ?>;</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="vertical-align: top;">
                    Selama <?= hitungHari($row1->tanggal_mulai, $row1->tanggal_selesai); ?>
                    hari kalender dan pekerjaan harus sudah selesai pada tanggal
                    <strong><?php echo formatTanggalIndonesia($row1->tanggal_selesai); ?></strong>
                </td>
            </tr>
            <tr>
                ...
                <td style="width:2%; vertical-align: top;">:</td>
                <td style="vertical-align: top;">
                    terhadap setiap hari keterlambatan pelaksanaan/penyelesaian pekerjaan Penyedia akan dikenakan Denda
                    Keterlambatan sebesar 1/1000 (satu per seribu) dari bagian tertentu dari Nilai Kontrak sebelum PPN
                    sesuai dengan ketentuan yang tercantum dalam Syarat-Syarat Khusus Kontrak.
                </td>
            </tr>
        </table>
        <!-- END: Isi 3 -->
