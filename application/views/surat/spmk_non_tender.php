...
<head>
    ...
    <title>SPPBJ Konstruksi Non Tender - <?php echo $row2->paket_pekerjaan; ?></title>
    <style>
        @font-face {
    ...
    <div class="container" style="padding-top: 25px;">
        ...
        <tr style=''>
          ...
          <td>
            ...
            <div style="text-align:center;font-size:11pt;">SUB KEGIATAN <?php echo strtoupper($row2->sub_kegiatan); ?></div>
...
<tr>
        <td colspan="3">Selanjutnya disebut sebagai <span style="font-weight:bold">Pejabat Penandatangan Kontrak;</span></td>
    </tr>
</table>
<!-- END: Data PPK -->
...
<table>
 <td style="text-align:justify">
   Berdasarkan Surat Perjanjian (Kontrak) Nomor : <?php echo $row2->nomor_kontrak; ?> tanggal <?php echo formatTanggalIndonesia($row2->tanggal_kontrak); ?>, bersama ini memerintahkan:
</td>
</table>
<!-- END: Isi 2 -->
...
<table>
   <tr>
       <td style="width:35%">Nama Penyedia</td>
       <td>:</td>
...
<tr>
        ...
        <td style="width:30%; vertical-align: top;">Ruang Lingkup Pekerjaan</td>
        <td style="width:2%; vertical-align: top;">:</td>
        <td style="vertical-align: top;"><?php echo $row1->ruang_lingkup; ?></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td style="vertical-align: top;">
            Selama <?php echo $row2->masa_pelaksanaan; ?> (<?php echo terbilang($row2->masa_pelaksanaan); ?>) hari kalender dan pekerjaan harus sudah selesai pada tanggal <strong><?php echo formatTanggalIndonesia($row2->tanggal_selesai); ?></strong>
        </td>
    </tr>
    <tr>
        <td style="width:4%; vertical-align: top;">5.</td>
        <td style="width:30%; vertical-align: top;">Denda</td>
        <td style="width:2%; vertical-align: top;">:</td>
        <td style="vertical-align: top;">
            terhadap setiap hari keterlambatan pelaksanaan/penyelesaian pekerjaan Penyedia akan dikenakan Denda Keterlambatan sebesar 1/1000 (satu per seribu) dari bagian tertentu dari Nilai Kontrak sebelum PPN sesuai dengan ketentuan yang tercantum dalam Syarat-Syarat Khusus Kontrak.
        </td>
    </tr>
</table>
<!-- END: Isi 3 -->
