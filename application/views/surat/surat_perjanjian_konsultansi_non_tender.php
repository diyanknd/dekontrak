        ...
        <table style="border: 1px solid black; border-collapse: collapse;">
            ...
            <tr style="border: 1px solid black; border-collapse: collapse;">
                <td colspan="2" style="padding-left: 10px; padding-bottom:10px">
                    ...
                    Nilai
                    (PPN) adalah sebesar Rp 91.357.250,00 (Sembilan Puluh Satu Juta Tiga Ratus Lima Puluh Tujuh Ribu Dua
        ...
        <table style="border: 1px solid black; border-collapse: collapse;">
            <tr style="border: 1px solid black; border-collapse: collapse;">
                <td colspan="3" style="padding-left: 10px; padding-bottom:10px">
                    ...
                    ke
                    Bank BPD Kaltim Kaltara rekening nomor : 0061543767 atas nama Penyedia : CV. Tandan Jaya
                    Pembayaran prestasi pekerjaan dilakukan dengan cara : Sekaligus
                </td>
            </tr>
            <tr style="border: 1px solid black; border-collapse: collapse;">
                <td colspan="3" style="padding-left: 10px; padding-bottom:10px">
                    <span style="font-weight:bold">JENIS KONTRAK:</span><br> Lumsum
                </td>
            </tr>
            <tr style="border: 1px solid black; border-collapse: collapse;">
                <td colspan="3" style="padding-left: 10px; padding-bottom:10px">
                    <span style="font-weight:bold">MASA PELAKSANAAN PEKERJAAN:</span><br> 30 (Tiga Puluh) Hari Kalender
                </td>
            </tr>
