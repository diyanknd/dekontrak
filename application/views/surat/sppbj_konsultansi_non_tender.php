...
<head>
    ...
    <title>SPPBJ Konstruksi - <?php echo $row2->paket_pekerjaan; ?></title>
    <style>
        @font-face {
...
<body>
    <div class="container" style="padding-top: 25px;">
        ...
        <table style="margin-bottom: 0px">
            <td>
                <div class="justify">
                    Dengan ini kami beritahukan bahwa penawaran Saudara dengan kode paket
                    <?php echo $row1->kode_paket; ?> tanggal <?php
                        $tanggal = $row1->tanggal_kode_paket;
                        $bulan = array("Januari", "Februari", "Maret", "April", "Mei", "Juni", "Juli", "Agustus", "September", "Oktober", "November", "Desember");
                        $tanggal_format = date("d", strtotime($tanggal));
                        $bulan_index = date("n", strtotime($tanggal)) - 1;
                        $tahun = date("Y", strtotime($tanggal));
                        echo $tanggal_format . " " . $bulan[$bulan_index] . " " . $tahun;
                        ?>
                    tentang Pengadaan Langsung Paket Pekerjaan <?php echo $row2->paket_pekerjaan; ?> dengan nilai hasil
