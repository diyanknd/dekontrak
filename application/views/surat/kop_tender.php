...
<body>
    <?php for ($i = 1; $i <= $jumlah_rangkap; $i++) { ?>
        ...
        <div class="container"
            style="padding-top: 1px;padding-left: 1px;padding-right: 1px;padding-bottom: 1px; border: 2px solid black; border-collapse: collapse; border-radius: 30px;">
            <div class="container"
                style="padding-top: 10px;padding-left: 25px;padding-right: 25px;padding-bottom: 25px; border: 4px solid black; border-collapse: collapse; border-radius: 30px;">
                <!-- BEGIN: Kop Surat -->
              ...
              margin-left:8px;margin-top:3px;width:81px;height:96px'><img width=81 height=96
                        ...
                        <td>
                            <div style="text-align:center;font-size:16pt;font-weight: bold;">PEMERINTAH KABUPATEN BERAU
                            </div>
                            <div style="text-align:center;font-size:14pt;font-weight: bold;">DINAS PEKERJAAN UMUM DAN
                                PENATAAN RUANG</div>
